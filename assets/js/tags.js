/* File: rapidtext-ai-cats-tags.js */
(function () {
    ...
    const RapidTextAiCatsTagsPanel = () => {
        ...
        const handleGenerate = async () => {
            try {
                ...
                alert(__('Error generating categories/tags: ', 'rapidtextai') + err.message);
            } finally {
                setIsLoading(false);
            }
        };
        ...
        return createElement(
            ...
            {
                name: 'rapidtext-ai-cats-tags-panel',
                title: __('AI Categories & Tags', 'rapidtextai'),
                className: 'rapidtext-ai-cats-tags-panel',
            },
            ...
            [
                ...
                createElement(
                    ...
                    createElement(RangeControl, {
                        label: __('Desired # of Categories', 'rapidtextai'),
                        min: 1,
                        max: 10,
                        value: desiredCats,
                ...
                createElement(
                    ...
                    createElement(
                        ...
                        isLoading
                            ? __('Generating...', 'rapidtextai')
                            : __('Generate via AI', 'rapidtextai')
                    ),
    ...
    registerPlugin('rapidtext-ai-cats-tags', {
        render: RapidTextAiCatsTagsPanel,
